...
SecondScene::SecondScene(const char* name, const char* tilemapFile, int srcTileW, int srcTileH, int tileCountW, int tileCountH) :
...
void SecondScene::Load()
{
	...
	std::string MusicFile = ASSET_PATH + std::string("Music/SecondSceneMusic.mp3");
